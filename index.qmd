...
![RGB image](images/Training_image/RGB_image.png)

![CIR image](images/Training_image/CIR_image.png)

![LiDAR point cloud](images/Training_image/LiDAR.png)

![CHM raster](images/Training_image/CHM_all_color.png)
...
::: {#fig-dataset-augmentation layout="[[48, -4, 48, -4, 48, -4, 48], [-4], [48, -4, 48, -4, 48, -4, 48], [-4], [48, -4, 48, -4, 48, -4, 48], [-4], [48, -4, 48, -4, 48, -4, 48]]" layout-valign="top"}

![Initial image](images/Augmentations/RGB_image.png)

![Transformed image n°1](images/Augmentations/RGB_image_transformed_1.png)

![Transformed image n°2](images/Augmentations/RGB_image_transformed_2.png)

![Transformed image n°3](images/Augmentations/RGB_image_transformed_3.png)

![Transformed image n°4](images/Augmentations/RGB_image_transformed_4.png)

![Transformed image n°5](images/Augmentations/RGB_image_transformed_5.png)

![Transformed image n°6](images/Augmentations/RGB_image_transformed_6.png)

![Transformed image n°7](images/Augmentations/RGB_image_transformed_7.png)

![Transformed image n°8](images/Augmentations/RGB_image_transformed_8.png)

![Transformed image n°9](images/Augmentations/RGB_image_transformed_9.png)

![Transformed image n°10](images/Augmentations/RGB_image_transformed_10.png)

![Transformed image n°11](images/Augmentations/RGB_image_transformed_11.png)

![Transformed image n°12](images/Augmentations/RGB_image_transformed_12.png)

![Transformed image n°13](images/Augmentations/RGB_image_transformed_13.png)

![Transformed image n°14](images/Augmentations/RGB_image_transformed_14.png)

![Transformed image n°15](images/Augmentations/RGB_image_transformed_15.png)

Examples of data augmentations on an RGB image with the probabilities used when training the model. Multiple effects can be seen, such as channel dropouts, luminosity changes, perspective changes, blurring and distortion.
:::
