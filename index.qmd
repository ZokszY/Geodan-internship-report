...
Benchmark of 8 methods using LiDAR [@lidar_benchmark]:  one of the methods uses multiple CHM layers, computed iteratively by removing everything in the 0.5 m below the previous CHM
