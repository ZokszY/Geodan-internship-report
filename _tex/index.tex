...
the area. On Figure~\ref{fig-dataset-gt-boxes}, you can see what the
dataset finally looks like, with all data sources and bounding boxes.
...
\subcaption{\label{}LiDAR point cloud}
\end{minipage}%
%
\begin{minipage}{0.04\linewidth}
~\end{minipage}%
...
On the example below (Figure~\ref{fig-dataset-gt-boxes}), you can see
two of the issues. First, you can see that a bounding box that is
well-centered around the tree in the RGB image is completely off on the
CIR image, and also not really centered on the CHM raster. Then, you can
see that the bounding box is much smaller on the CHM, mainly for two
reasons: the tree grew between the acquisition of the LiDAR point cloud
and the RGB image and small branches on the outside of the tree are hard
to capture for LiDAR beams.
...
On Figure~\ref{fig-dataset-augmentation}, you can see an RGB image and
15 random augmentations of this image, generated with the
transformations and the probabilities used during training. The most
visible change happens when one or two color channels are dropped, but
we can also see luminosity changes in images n°4 and 14, perspective
changes in n°5, 8 and 13, blurring in n°1 and 14, and distortions in
n°10 and 12. All these effects and some other less identifiable
augmentations (like noise), are randomly combined to produce many
different images, with bounding boxes being modified accordingly.

\begin{figure}

\begin{minipage}{0.23\linewidth}

\includegraphics{images/Augmentations/RGB_image.png}

\subcaption{\label{}Initial image}
\end{minipage}%
%
...
\includegraphics{images/Augmentations/RGB_image_transformed_1.png}

\subcaption{\label{}Transformed image n°1}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_2.png}

\subcaption{\label{}Transformed image n°2}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_3.png}

\subcaption{\label{}Transformed image n°3}
\end{minipage}%
\newline
\begin{minipage}{\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_4.png}

\subcaption{\label{}Transformed image n°4}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_5.png}

\subcaption{\label{}Transformed image n°5}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_6.png}

\subcaption{\label{}Transformed image n°6}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_7.png}

\subcaption{\label{}Transformed image n°7}
\end{minipage}%
\newline
\begin{minipage}{\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_8.png}

\subcaption{\label{}Transformed image n°8}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_9.png}

\subcaption{\label{}Transformed image n°9}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_10.png}

\subcaption{\label{}Transformed image n°10}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_11.png}

\subcaption{\label{}Transformed image n°11}
\end{minipage}%
\newline
\begin{minipage}{\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_12.png}

\subcaption{\label{}Transformed image n°12}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_13.png}

\subcaption{\label{}Transformed image n°13}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_14.png}

\subcaption{\label{}Transformed image n°14}
\end{minipage}%
%
\begin{minipage}{0.02\linewidth}
~\end{minipage}%
...
\includegraphics{images/Augmentations/RGB_image_transformed_15.png}

\subcaption{\label{}Transformed image n°15}
\end{minipage}%

\caption{\label{fig-dataset-augmentation}Examples of data augmentations
on an RGB image with the probabilities used when training the model.
Multiple effects can be seen, such as channel dropouts, luminosity
changes, perspective changes, blurring and distortion.}
...
\includegraphics{index_files/figure-pdf/fig-training-parameters-data-output-1.pdf}
...
\section{Discussion and improvements}\label{discussion-and-improvements}
